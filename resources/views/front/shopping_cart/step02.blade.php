    ...
    <div class="cart-block">
        <div class="cart-detail p-5">
            <div class="shopping-progress ">
                ...
                <hr />
                <form action="" method="POST" class="payment" id="payment">
                    @csrf
                    <h4>付款方式</h4>
                    <div class="container">
                        <div class="col">
                            ...
                            <div class="row d-flex align-items-center py-1">
                                <input class="mr-2" type="radio" name="payment" value="Credit" required @if ($payment == 'Credit') checked @endif>
                                <h5 class="m-0">信用卡付款</h5>
                            </div>
                            <hr />
                            <div class="row d-flex align-items-center py-1">
                                <input class="mr-2" type="radio" name="payment" value="ATM" required @if ($payment == 'ATM') checked @endif>
                                <h5 class="m-0">網路ATM</h5>
                            </div>
                            <hr />
                            <div class="row d-flex align-items-center py-1">
                                <input class="mr-2" type="radio" name="payment" value="CVS" required @if ($payment == 'CVS') checked @endif>
                    ...
                    <div class="shipment">
                        ...
                        <div class="container">
                            <div class="col">
                                @php
                                    $payment = Session::get('shipment');
                                @endphp
                                <div class="row d-flex align-items-center py-1">
                                    <input class="mr-2" type="radio" name="shipment" value="Home" required @if ($shipment = 'Home') checked @endif>
                                    <h5 class="m-0">黑貓宅配</h5>
                                </div>
                                <hr />
                                <div class="row d-flex align-items-center py-1">
                                    <input class="mr-2" type="radio" name="shipment" value="C2C" required @if ($shipment = 'C2C') checked @endif>
                ...
                <div class="action-button d-flex justify-content-between align-items-center">
                    <a href="./step01" class="btn btn-outline-primary btn-lg">上一步</a>
                    <a href="./step03" class="btn btn-primary btn-lg" id="next">下一步</a>
                </div>
            </div>
        </div>
    </div>
