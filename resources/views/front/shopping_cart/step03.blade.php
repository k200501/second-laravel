                ...
                <div class="container">
                    <form action="" method="POST" class="col p-0">
                        ...
                        <div class="row">
                            ...
                            <input type="text" name="name" id="name" class="form-control" placeholder="王小明">
                            {{-- <h5>姓名</h5><input type="text" class="form-control" placeholder="王小明" aria-label="Username"
                                aria-describedby="basic-addon1"> --}}
                        </div>
                        <div class="row">
                            <label for="phone">電話</label>
                            <input type="text" name="phone" id="phone" class="form-control" placeholder="0912345678">
                            {{-- <h5>電話</h5><input type="text" class="form-control" placeholder="0912345678"
                                aria-label="Username" aria-describedby="basic-addon1"> --}}
                        </div>
                        <div class="row">
                            <label for="email">信箱</label>
                            <input type="text" name="email" id="email" class="form-control" placeholder="abd123@gmail.com">
                        ...
                        <div class="col p-0">
                            ...
                            <div class="row py-1">
                                <input type="text" class="form-control" placeholder="地址" aria-label="Username" aria-describedby="basic-addon1">
                            </div>
                        </div>
                        <hr>
                        ...
                        <div class="action-button d-flex justify-content-between align-items-center">
                            <a href="./step02"><button
                                    class="btn btn-outline-primary btn-lg">上一步</button></a>
                            <a href="./step04"><button class="btn btn-primary btn-lg">前往付款</button></a>
                        </div>
                    </form>
                </div>
            </div>
